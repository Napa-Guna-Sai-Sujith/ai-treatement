      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex flex-wrap gap-1 mb-6 bg-slate-800/50 rounded-xl p-1 border border-white/5 w-fit">
          {[
            ...
            { id: 'patients' as Tab, label: 'Patient Registry', icon: 'M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z' },
        ...
        {activeTab === 'aiquantum' ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              {!selectedPatient && activeTab !== 'overview' && activeTab !== 'dataset' && activeTab !== 'patients' && (
